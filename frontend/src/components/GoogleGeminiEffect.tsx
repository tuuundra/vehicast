...
export const GoogleGeminiEffect: React.FC<GoogleGeminiEffectProps> = ({
  ...
  return (
    <Box position="relative" h="890px" w="full">
      <Box as="svg"
        width="100%"
        height="890px"
        ...
        position="absolute"
      >
        {/* Background blurred paths with reduced opacity */}
        <path
        ...
        {/* Animated paths with animated flowing gradients */}
        <defs>
          <linearGradient id="greenGradient" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="100%" stopColor="#3ecf8e">
              <animate attributeName="offset" values="0.5;2.5" dur="8s" repeatCount="indefinite" />
            </stop>
          </linearGradient>
          
          <linearGradient id="tealGradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#6dc4a7">
              <animate attributeName="offset" values="-0.5;1.5" dur="10s" repeatCount="indefinite" />
            </stop>
            <stop offset="50%" stopColor="#0ea5e9">
              <animate attributeName="offset" values="0;2" dur="10s" repeatCount="indefinite" />
            </stop>
            <stop offset="100%" stopColor="#6dc4a7">
          ...
          <linearGradient id="purpleGradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#9d5cff">
              <animate attributeName="offset" values="-0.5;1.5" dur="12s" repeatCount="indefinite" />
            </stop>
            <stop offset="50%" stopColor="#d946ef">
              <animate attributeName="offset" values="0;2" dur="12s" repeatCount="indefinite" />
            </stop>
            <stop offset="100%" stopColor="#9d5cff">
              <animate attributeName="offset" values="0.5;2.5" dur="12s" repeatCount="indefinite" />
            </stop>
          </linearGradient>
          
          <linearGradient id="redGradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#ef4444">
              <animate attributeName="offset" values="-0.5;1.5" dur="9s" repeatCount="indefinite" />
            </stop>
            <stop offset="50%" stopColor="#f97316">
              <animate attributeName="offset" values="0;2" dur="9s" repeatCount="indefinite" />
            </stop>
            <stop offset="100%" stopColor="#ef4444">
              <animate attributeName="offset" values="0.5;2.5" dur="9s" repeatCount="indefinite" />
            </stop>
          </linearGradient>
